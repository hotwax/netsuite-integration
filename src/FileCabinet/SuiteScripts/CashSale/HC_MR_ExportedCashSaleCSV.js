    ...
    (file, record, search, sftp, format, error) => {
        const getInputData = (inputContext) => {
            ...
            var customRecordSearch = search.create({
                ...
                columns: ['custrecord_cashsale_ex_date']
            });
            ...
            var lastSalesOrderExportDate = searchResult.getValue({
                name: 'custrecord_cashsale_ex_date'
            });
            ...
            // Copy the filters from cashSaleSearch into defaultFilters.
            var defaultFilters = cashSaleSearch.filters;
            ...
            cashSaleSearch.filters = defaultFilters;
                ...
                if (totalRecordsExported > 0) {
                    ...
                    */
                    ...
                    record.submitFields({
                        ...
                        values: {
                            custrecord_cashsale_ex_date : currentDate
                        }
                    });
                }
            } catch (e) {
