...
define(['N/sftp', 'N/error', 'N/search'], function (sftp, error, search) {
    function execute(context) {
      try {
        ...
        connection.makeDirectory({
            path: 'transferorderv2/import/fulfillment-wh/archive'
        });
        ...
        connection.makeDirectory({
            path: 'transferorderv2/update'
        });

        connection.makeDirectory({
            path: 'transferorderv2/update/archive'
        });

        connection.makeDirectory({
            path: 'transferorderv2/update/failed'
        });

        connection.makeDirectory({
            path: 'transferorderv2/update/error'
        });
        ...
        connection.makeDirectory({
            path: 'inventoryadjustment/cycle_count'
        });
        connection.makeDirectory({
            path: 'inventoryadjustment/cycle_count/archive'
        });
